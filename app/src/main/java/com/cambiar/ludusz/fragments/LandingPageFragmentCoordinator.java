...
public class LandingPageFragmentCoordinator extends Fragment implements View.OnClickListener {
    private static final String TAG = LandingPageFragmentCoordinator.class.getSimpleName();

    private static WeakReference<LandingPageFragmentCoordinator> homeFragmentWeakReference;
    private LandingPageFavoriteBlogAdapter landingPageFavoriteBlogAdapter;

    public static LandingPageFragmentCoordinator getInstance() {
        if (homeFragmentWeakReference == null) {
            homeFragmentWeakReference = new WeakReference<>(new LandingPageFragmentCoordinator());
        }
        return homeFragmentWeakReference.get();
    }

    public LandingPageFragmentCoordinator() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_landing_page_coordinator, container, false);
