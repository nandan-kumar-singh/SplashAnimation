 ...
 */
public class LandingPageFavoriteBlogAdapter extends RecyclerView.Adapter<LandingPageFavoriteBlogAdapter.MyViewHolder> {
    List<Blog> blogList = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;

    public LandingPageFavoriteBlogAdapter(Context context, List<Blog> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.layout_favorite_blog, parent, false);
